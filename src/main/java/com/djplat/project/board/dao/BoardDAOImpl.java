...
public class BoardDAOImpl implements BoardDAO {
	...
	public List selectAllArticlesList3(Map pagingMap) throws DataAccessException {
		List<ArticleVO> articlesList = sqlSession.selectList("mapper.board.selectAllArticlesList3",pagingMap);
		return articlesList;
	}
	@Override
	public List selectAllArticlesList4(Map pagingMap) throws DataAccessException {
		List<ArticleVO> articlesList = sqlSession.selectList("mapper.board.selectAllArticlesList4",pagingMap);
		return articlesList;
	}
	@Override
	public List selectAllArticlesList5(Map pagingMap) throws DataAccessException {
		List<ArticleVO> articlesList = sqlSession.selectList("mapper.board.selectAllArticlesList5",pagingMap);
		return articlesList;
	}
	@Override
