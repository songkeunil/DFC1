package com.djplat.project.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.djplat.*.service.*.*(..)) or " + "execution(* com.djplat.*.dao.*.*(..))")
	...
	@After("execution(* com.djplat.*.service.*.*(..)) or " + "execution(* com.djplat.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.djplat.*.service.*.*(..)) or " + "execution(* com.djplat.*.dao.*.*(..))")
