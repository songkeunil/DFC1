...
<body>
 <div id='boardrap'>
        <div id='boardtop'>
            <h2>찾아오시는 길<br></h2><br>
            <br>
            <a href='#'><i class="bi bi-house-door"></i>Home </a> > <a href='#'> 청춘끼리소개 </a> > <a href='#'>찾아오시는 길</a>
        </div>
        ...
        <div class="vision"></div>
           <div class="vision-img"> <img src="${path}/resources/image/sogaeRoad.png"></div>
           
           <div class="vision saeop-img"><img src="${path}/resources/image/sogaeBus.png"></div>
