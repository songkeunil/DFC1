...
<body>
    ...
    <div id='sograp'>
        <div id='sogtop'>
            <h2>찾아오시는길<br></h2><br>
            <br>
            <a href='#'><i class="bi bi-house-door"></i>Home </a> > <a href='#'> 청춘너나들이 </a> > <a href='#'>찾아오시는길</a>
        </div>
        <!--중앙부분 시작-->
       <div class="title-box">
          <h3 class="sc-title">청춘너나들이</h3>
          <p class="sc-title-text">
            주소 : 대전광역시 서구 둔산중로 19<br class="inct-tab-mt-none inct-m-i"> <br>
            전화번호 : 070-4275-9995<br>
            이메일 : info@bloomwork.io
          </p>
<!--          -->
...
<!--                    <div class="bus-tag"><span>외곽</span></div>-->
                  ...
                  <li class="blue">
                    <div class="bus-tag line2"><span>일반</span></div>
                    <p class="number">104, 911,105, 706, 618<br>..........................................................................</p>
                  </li>
                  <li class="green">
...
<!--                    <div class="bus-tag"><span>급행</span></div>-->
              ...
              <div class="traffic-info subway">
                ...
                <ul class="traffic-list">
                  <li>지하철 1호선 → 시청역(탄방역)에서 보라매 공원방향,시청 남문 100M</li>
                </ul>
              </div>
            </div>          
          <!-- 버스 지하철 -->
