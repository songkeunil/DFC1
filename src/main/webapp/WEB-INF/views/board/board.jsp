...
<div id='boardrap'>
        <div id='boardtop'>
            <h2>자유게시판<br></h2><br>
            <p>자유게신판은 자유롭게 의견을 게시 할 수 있는 열린공간입니다. 상업성 광고, 저속한 표현,특정인에 대한 비방, 정치적 목적이나 성향, 동일인이라고 인정되는 자가 동일 <br>또는 유사 내용을 반복한 게시글 등은 관리자에 의해
            ...
            <br>
            <a href='#'><i class="bi bi-house-door"></i>Home </a> > <a href='#'> 청년의목소리 </a> > <a href='#'>자유게시판</a>
        </div>
        <div id='board'>
            <table>
                <thead>
        ...
        <div id='boardfooter'>
           <div id = 'boardbtnbox'>
            <button type='button' onclick="location.href='#'" class='boardbtn'><i class="bi bi-pencil"></i>&nbsp글쓰기</button>
