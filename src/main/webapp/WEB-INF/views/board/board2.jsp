...
<html>
<head>
<link href="${path}/resources/css/board2.css" rel="stylesheet"/>
...
<body>
 <div id='boardrap'>
        ...
        <div id='board'>
            ...
            <button type='button' onclick="location.href='#'" class = 'boardtopbutton'>자료실</button>
            <table>
                <thead>
                    <tr>
                        <th id=th-1>번호</th>
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td class = 'text-color'><a href = '#'>[청춘소식]</a></td>
