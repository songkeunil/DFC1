...
<script type="text/javascript">
     function backToList(obj){
	    obj.action="${contextPath}/yp/ypconsult_board.do";
	    obj.submit();
     }
	...
	$(document).ready(function () {
		...
		$(function(){
	    	$("#y-detail-comment").load('${contextPath}/yp/boardView_re.do',{brd_no});
		});
	});
 </script>
<link rel="stylesheet"
	...
	<div id='y-boardrap'>
		<div id='y-boardtop'>
			...
			<br> <a href='#'><i class="y-bi bi-house-door"></i>Home </a> > <a
				href='#'> 청년마음건강 </a> > <a href='${contextPath }/yp/ypconsult_board.do'>이용후기</a>
		</div>
		<div id='y-detail-rap'>
			...
			<div id='y-detail-main'>${article.young_context}</div>
...
<!-- 			댓글입력창 -->
    ...
    <div id='y-detail-comment'>
			...
			<form name="replyForm" method="post"
				action="${contextPath }/yp/addNewReply.do?brd_no=${article.brd_no}">
			...
			<div id='y-detail-bottom-rap'>
				...
				<button type="button">
					<a href="${contextPath}/yp/modyp.do?brd_no=${article.brd_no}">수정하기</a>
				</button>
				<input type="button"
					onclick="fn_remove_article('${contextPath}/yp/removeArticle.do?brd_no=${article.brd_no}',
					 ${article.brd_no})"
					value="삭제하기">	
					...
					<button type='button' onclick='location.href="${contextPath }/yp/mrWriteForm.do"'>
						<i class="y-bi bi-pencil"></i>글쓰기
					</button>
					
					<button type='button' class='boardbtn' onclick="location.href='${contextPath }/yp/ypconsult_board.do'">
