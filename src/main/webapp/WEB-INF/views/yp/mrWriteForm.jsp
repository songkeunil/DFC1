...
<div id='y-boardrap'>
        <div id='y-boardtop'>
            ...
            <br>
            <a href='#'><i class="y-bi bi-house-door"></i>Home </a> > <a href='#'> 청년마음건강 </a> > <a href='${contextPath}/yp/ypconsult_board.do'>이용후기</a>
        </div>
        ...
        <form name="articleForm" method="post"  action="${contextPath}/yp/addArticle.do"   enctype="multipart/form-data"  accept-charset="utf-8">
        <div id='y-write'>
				<div id='y-writetop'>
            ...
            <div id='y-writemiddle'>
                <textarea name="young_context" id="ir1"></textarea>
            </div>
