...
<html>
<head>
<link href="${contextPath}/resources/css/viewArticle.css" rel="stylesheet"/>
...
<style>
   ...
   <script type="text/javascript" >
     function backToList(obj){
	    obj.action="${contextPath}/djnboard/listArticles.do";
	    obj.submit();
     }
...
<div id='y-boardrap'>
        <div id='y-boardtop'>
            ...
            <p class='y-p'>자유게시판은 자유롭게 의견을 게시 할 수 있는 열린공간입니다. 상업성 광고, 저속한 표현,특정인에 대한 비방, 정치적 목적이나 성향, 동일인이라고 인정되는 자가 동일 <br>또는 유사 내용을 반복한 게시글 등은 관리자에 의해
                통보없이 삭제될 수 있습니다. <br>또한, 홈페이지를 통하여 불법유해 정보를 게시하거나 배포하면 정보통신망 이용촉진 및 정보보호 등에 관한 법률 제74조에 의거 1년이하의 징역 또는 1천만원 이하의 벌금에 처해질 수 있습니다.</p>
            <br>
            <a href='#'><i class="y-bi bi-house-door"></i>Home </a> > <a href='#'> 대청넷 </a> > <a href='#'>대청넷활동</a>
        </div>
        <div id='y-detail-rap'>
            <div id='y-detail-title'>
                <table>
                    <tr>
                        ...
                        <th class='y-detail-title-th2'><i class="bi bi-eye-fill"></i> ${article.hits}</th>
			...
			<form name="downloadForm" method="post" action="${contextPath }/djnboard/download.do?brd_no=${article.brd_no}">
           ...
           <br><br>
            ...
            <div id=y-detail-comment>
                ...
                <div class='y-detail-comment-middle'>
                    <div class="y-detail-comment-middle-profile"> <i class="bi bi-person-fill"></i></div>
                    <div>
                        ...
                        <div class="y-detail-comment-middle-info-main">2021년 대전시 해외취업지원사업 전문분야 국내외 항공사 및 외국기업 취업역량강화 교육 참여자
                            모집중입니다.
                        </div>
                        <div class="reply"><a href="#">답글</a></div>
                    </div>
                      </div>
                   ...
                   <div class="y-detail-comment-middle-reply-rap"><div class="reply-arrow">
                   <i class="bi bi-arrow-return-right"></i></div>
                    <div class='y-detail-comment-middle-reply'>
                        ...
                        <div>
                            ...
                            <div class="y-detail-comment-middle-info-main-ㄷreply">2021년 대전시 해외취업지원사업 전문분야 국내외 항공사 및 외국기업 취업역량강화 교육 참여자
                                모집중입니다.
                            </div>
                        </div>
                    </div>
            ...
            <div class="y-detail-comment-write-rap">
                ...
                <button type='button' onclick="location.href='#'" ><i class="bi bi-chat"></i> 등록</button>
            </div>

            	<div id = 'y-detail-bottom-rap'>
            	<div class = 'y-detail-bottom-left'>
                	<button type='button' onclick="location.href='#'" ><i class="y-bi bi-chevron-left"></i> 이전</button>
                	<button type='button' onclick="location.href='#'" >다음<i class="y-bi bi-chevron-right"></i></button>
            	</div>
	      			<button type="button"><a href="${contextPath}/djnboard/forModShowArticles.do?brd_no=${article.brd_no}">수정하기</a></button>
	      			<input type="button" onclick="fn_remove_article('${contextPath}/djnboard/removeArticle.do', ${article.brd_no})" value="삭제하기">
            	<div class = 'y-detail-bottom-right'>
                	<button type='button' onclick="location.href='#'" ><i class="y-bi bi-pencil"></i>글쓰기</button>
                	<button type='button' onclick="location.href='${contextPath}/djnboard/listArticles.do'" /><i class="bi bi-justify"></i>목록</button>
            	</div>
        		</div>
    </div>
</body>
