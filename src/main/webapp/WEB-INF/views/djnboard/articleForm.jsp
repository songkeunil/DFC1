<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	%>
     ...
     <c:set var="article" value="${articleMap.articleList }"></c:set>
<!DOCTYPE html>
<html>
<head>
...
<div id='y-boardrap'>
        ...
        <form name="articleForm" method="post"  action="${contextPath}/djnboard/addNewArticle.do"   enctype="multipart/form-data"  accept-charset="utf-8">
        <div id='y-write'>
            ...
            <div id='y-writetop'>
                <div class='y-writetop-option'>
                    ...
                    <div class="y-writetop-option-tab" style="float: left;">
                    <input type="radio" value="공지" name="cc">공지
                   	<input type="radio" value="자료" name="cc">자료
                    <input type="radio" value="뉴스" name="cc">뉴스
                    <input type="radio" value="설문조사" name="cc">설문조사
                    </div>
            </div>
